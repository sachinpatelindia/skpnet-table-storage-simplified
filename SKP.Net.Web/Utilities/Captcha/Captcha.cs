...
namespace SKP.Net.Web.Utilities.Captcha
{
    public static class Captcha
    {
        ...
        public static bool ValidateOTP(string userInputCaptcha, HttpContext context)
        {
            var isValid = userInputCaptcha == context.Session.GetString("otp");
